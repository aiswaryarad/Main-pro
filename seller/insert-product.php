...
$file_ext=strtolower(end(explode('.',$_FILES['productimage1']['name'])));
...
$select = "SELECT * FROM product WHERE product_name ='$productname' and seller_id='$seller_id'";
...
$sql=mysqli_query($con,"insert into product(category_id,product_name,price,Total_quantity,product_desc,product_image,seller_id) values('$category','$productname','$productprice',$productquantity,'$productdescription','$productimage1','$seller_id')");
...
<div class="controls">
<input type="number" style="height:30px"name="quantity" min=10 max =1000 placeholder="Enter Product quantity" class="span8 tip" pattern="[0-9]+" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Product Price</label>
<div class="controls">
<input type="number" style="height:30px"name="productprice" min=1 max=1000000 placeholder="Enter Product Price" class="span8 tip" pattern="\d+((,|\.)\d\d?)*" required>
</div>
</div>
...
$query2=mysqli_query($con,"select * from seller where seller.user_id='$user_id'"); 
    ...
    {?>
<input type="hidden" name="user" value="<?php echo $row['seller_id'];?>">
