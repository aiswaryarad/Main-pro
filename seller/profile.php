...
//         }
//         else{
    $sql=mysqli_query($con,"insert into customer(pincode,address,city,district,user_id)values('$pincode','$housename','$city','$district','$user_id')");
                ...
                <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
                    ...
                    <li class="nav-item">
                        ...
                        <li>
                            ...
                            <ul>
                            <a href="manageuser.php"><li>Profile information</li></a>
		                    <a href="manageseller.php"><li>Manage Address</li></a>
                        </ul>
                        </li>
                        <!-- <li>
...
<div class="controls">
<input type="text"name="name" pattern="^([A-Za-z]+ )+[A-Za-z]+$|^[A-Za-z]+$" placeholder="Enter Name" value="<?php echo htmlentities($row['username']);?>" class="span8 tip" readonly required>
</div>
</div>
...
<div class="controls">
<input type="text"name="pincode" placeholder="Enter pincode " class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">city</label>
<div class="controls">
<input type="text"name="city" placeholder="Enter city "  class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">District</label>
<div class="controls">
<input type="text"name="district"placeholder="Enter district "  class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">HouseName</label>
<div class="controls">
<input type="text"name="housename"  placeholder="Enter housename "  class="span8 tip" required>
</div>
</div>
