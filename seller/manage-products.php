...
<?php
 ...
 while($row=mysqli_fetch_array($query1))
 {
    ...
    while($row=mysqli_fetch_array($query2))
    {
      ...
      $query=mysqli_query($con,"SELECT * from product,category WHERE product.category_id=category.category_id and product.seller_id ='$seller_id' and product.status=0");
      $cnt=1;
...
<td><img height='100px' src='uploads/<?php echo htmlentities($row["product_image"]);?>'></td>
