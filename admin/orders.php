...
<td><?php echo htmlentities($row['customer_email']);?></td>
<td><?php echo htmlentities($row['customer_phone']);?></td>
<td><?php echo htmlentities($row['customer_address']);?></td>
<td><?php echo htmlentities($row['total_amount']);?></td>
<td><a href="order_item.php?id=<?php echo $row['id']?>" class="button">view</a></td>
</tr>
<?php $cnt=$cnt+1; } ?>
</table>
</div>
