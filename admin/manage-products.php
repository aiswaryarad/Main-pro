...
<tbody>
<?php $query=mysqli_query($con,"SELECT * from product,category,seller WHERE product.category_id=category.category_id and product.seller_id=seller.seller_id and product.status=0");
$cnt=1;
...
<td><img height='100px' src='../seller/uploads/<?php echo htmlentities($row["product_image"]);?>'></td>
