...
<tbody>
<?php $query=mysqli_query($con,"SELECT * from users,seller where users.user_id=seller.user_id and role=2");
$cnt=1;
...
<td><button class="btn"> <a href="../certificate_upload/reg certif.jpg"><i class="fa fa-download"></i></button></td>
<td> <?php echo htmlentities($row['agreement']);?></td>
<td><?php 
                ...
                <td>
                    ...
                    if($row['status']=="0") 
                        echo 
"<a href=sdeactive.php?id=".$row['user_id']."><button class='btn btn-primary'onclick='myFunction1()' >Deactivate</button></a>";
                    else 
                        echo 
"<a href=sactive.php?id=".$row['user_id']."><button class='btn btn-btn btn-danger' onclick='myFunction2()' >Activate</button></a>";
                    ?>    
      </td>
</td>
