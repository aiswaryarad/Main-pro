...
<table class="center">                       
            ...
            <section class="products section-padding">
                <div class="container">
                        ...
                        <?php
                         $sql="SELECT * from product where category_id='$category' and status=0";
                         $result = $conn-> query($sql);
                         $count = 0;
                         if ($result-> num_rows > 0){
                         while($row = $result-> fetch_assoc()){ 
                        if($count==3) //three images per row
                            ...
                            <div class="product-thumb">
                               ...
                               <img src= "./seller/uploads/<?php echo $row['product_image']?>"class="img-fluid product-image" alt="" width="350" height="500">
