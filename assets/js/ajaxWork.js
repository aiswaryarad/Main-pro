...
function categoryEditForm(id){
    $.ajax({
        url:"./adminView/editCategory.php",
        method:"post",
        data:{record:id},
        success:function(data){
            $('.allContent-section').html(data);
...
function updateSize(){
    ...
    $.ajax({
      url:'./controller/sizeUpdateController.php',
      method:'post',
      data:fd,
      processData: false,
      contentType: false,
...
function subcategoryDelete(id){
    $.ajax({
        url:"./controller/deleteSubcategoryController.php",
        method:"post",
        data:{record:id},
        success:function(data){
...
function subcategoryEditForm(id){
    $.ajax({
        url:"./adminView/editSubcategory.php",
        method:"post",
        data:{record:id},
        success:function(data){
            $('.allContent-section').html(data);
