...
<tbody>
<?php $query=mysqli_query($con,"SELECT * from users where role=0");
$cnt=1;
...
<td><?php 
                ...
                <td>
                    ...
                    if($row['status']=="0") 
                        echo 
"<a href=deactive.php?id=".$row['user_id']."><button class='btn btn-primary'onclick='myFunction1()' >Deactivate</button></a>";
                    else 
                        echo 
"<a href=active.php?id=".$row['user_id']."><button class='btn btn-btn btn-danger' onclick='myFunction2()' >Activate</button></a>";
                    ?>    
      </td>
</td>
