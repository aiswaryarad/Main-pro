...
{
$query=mysqli_query($con,"SELECT *from product,orders,order_items where orders.user_id='$user_id' and order_items.order_id =orders.id and product.product_id=order_items.product_id");
$cnt=1;
...
<td><img width='100px' height='10px'src='uploads/<?php echo htmlentities($row["product_image"]);?>'></td>
