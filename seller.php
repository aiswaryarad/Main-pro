    ...
    <body>
        ...
        <main>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav mx-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <a class="nav-link" href="./seller/seller_index.php"><i class=""></i> start selling</a>
                      ...
                      <div class="dropdown">
                        ...
                        <a href=" " style="font-size:11px" class="bi-person custom-icon me-3"> Hello-<?php echo htmlentities($_SESSION['username']);?></a>
                         ...
                         <?php } ?>
                                <a href="./seller/profile_update_seller.php">profile</a>
            ...
            <section class="slick-slideshow">   
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    <h1 class="slick-title">Launch your Business right with us..</h1>
                ...
                <div class="slick-custom">
                    <img src="images/slideshow/e0.jpg" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="images/slideshow/sell3.jpg" class="img-fluid" alt="">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <p class="lead text-white mt-lg-3 mb-lg-5">Sell With Us.</p>
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="images/sell4.webp" class="img-fluid" alt="">
                                        </div>

                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                <h4 class="mb-3">Start <span>your</span> <br>seller <span>journey</span></h4>

                                                <p>Whether you are a brand owner, a reseller, are new to selling, or have been doing it for years – bioMe has a wide range of options to help you find your customer and grow your business..</p>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="images/sell5.jpg" class="img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="px-5 py-5 py-lg-0">
                                ...
                                <p class="lead mb-4">You can sell your eco-produts at the cmfort of your home through our website.</p>
